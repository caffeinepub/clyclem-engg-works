...
import type { ExternalBlob as _ExternalBlob, Pdf as _Pdf, UserRole as _UserRole, Video as _Video, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deletePdf(arg0: PdfId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getPdfs(): Promise<Array<Pdf>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPdfs();
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string): Promise<InquiryId> {
        if (this.processError) {
            try {
    ...
    async uploadPdf(arg0: string, arg1: string, arg2: ExternalBlob): Promise<PdfId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPdf(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideo(arg0: string, arg1: string, arg2: ExternalBlob): Promise<VideoId> {
        if (this.processError) {
            try {
...
async function from_candid_Pdf_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Pdf): Promise<Pdf> {
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Pdf>): Promise<Array<Pdf>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Pdf_n13(_uploadFile, _downloadFile, x)));
}
